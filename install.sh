...
RELEASE_URL="https://github.com/silentg33k/chalkboard-installer/raw/main/releases/chalkboard-v1.0.0-rc1-maintwrap-docs.zip"
STAGE="/home/pi/chalkboard-upload"
ARCHIVE="/tmp/chalkboard-v1.0.0-rc1-maintwrap-docs.zip"
